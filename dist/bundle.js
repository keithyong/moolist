...
/******/ 	var hotCurrentHash = "841df6d3c5281524e631"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_todo2.default, initialState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Todo = __webpack_require__(179);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            var todos = this.props.todos.map(function (todo) {
	                return _react2.default.createElement(_Todo2.default, { key: todo.id, completed: todo.completed, text: todo.text });
	            });
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { onClick: this.props.dispatch({ type: 'ADD_TODO', text: 'client_side_todo_item' }) },
	                    'Add Todo'
	                )
	            );
	        }
